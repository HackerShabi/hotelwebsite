...
const initialRooms = [
  {
    ...
    amenities: [
      'Ocean View', 'King Size Bed', 'Free WiFi', 'Mini Bar',
      'Air Conditioning', 'Room Service', 'Balcony', 'Smart TV'
    ],
    maxGuests: 2,
    size: '45 sqm',
    bedType: 'King Size',
  ...
  },
  {
    ...
    amenities: [
      'City View', 'Separate Living Area', 'King Size Bed', 'Free WiFi',
      'Premium Mini Bar', 'Air Conditioning', '24/7 Room Service',
      'Private Balcony', 'Smart TV', 'Jacuzzi', 'Work Desk'
    ],
    maxGuests: 4,
    size: '85 sqm',
  ...
  },
  {
    ...
    amenities: [
      'Queen Size Bed', 'Free WiFi', 'Air Conditioning',
      'Work Desk', 'Smart TV', 'Coffee Maker'
    ],
    maxGuests: 2,
    size: '25 sqm',
    bedType: 'Queen Size',
  ...
  },
  {
    ...
    amenities: [
      'Double Bed + Bunk Beds', 'Free WiFi', 'Air Conditioning',
      'Mini Fridge', 'Smart TV', 'Play Area', 'Baby Cot Available'
    ],
    maxGuests: 4,
    size: '40 sqm',
